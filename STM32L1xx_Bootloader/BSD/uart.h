...
#define Default_USART1_INTERVAL_TIME 5  //定义串口两个包接收间隔时间限制值,4ms
#define Default_USART2_INTERVAL_TIME 4  //定义串口两个包接收间隔时间限制值,4ms
#define Default_USART3_INTERVAL_TIME 4  //定义串口两个包接收间隔时间限制值,4ms
...
//extern unsigned char USART1_RX[UART1_RBUF_SIZE];
//extern unsigned char USART2_RX[UART2_RBUF_SIZE];
//extern unsigned char USART3_RX[UART3_RBUF_SIZE];	
...
unsigned short int USART3_GetCharBlock(unsigned short int timeout);
unsigned short int USART3_GetChar(void);
